...
// THIS WHEEL IS GOING BACKWARDS 
// method: swap two hall wires (in software), then there are 3 possible phase wire swaps 

// I will swap A (yellow) and B (orange)
    // HALL_1_PIN changes from 24 to 25
    // HALL_2_PIN changes from 25 to 24 

// This means that there are 3 possible ways to swap remaining phase wires, one of these will be correct

    // Phase A and Phase B swap
        // New hall order: HALL_1_PIN = 25, HALL_2_PIN=24, HALL_3_PIN = 26
        // New phase wire order: Physical change, swap blue wire and white wire

    // Phase A and Phase C swap
        // New hall order: HALL_1_PIN = 25, HALL_2_PIN=24, HALL_3_PIN = 26
        // New phase wire order: Physical change, swap blue wire and brown wire
        // TRY THIS FIRST

    // Phase B and Phase C swap 
        // New hall order: HALL_1_PIN = 25, HALL_2_PIN=24, HALL_3_PIN = 26
        // New phase wire order: Physical change, swap white wire and brown wire
...
#define HALL_1_PIN 25       // hall A, yellow
#define HALL_2_PIN 24       // hall B, orange
#define HALL_3_PIN 26       // hall C, green 

// Pins from the Teensy to the gate drivers. AH = A high, etc
// A = blue, B = white, C = brown 
